...
Technical debt impacts the growth equation **a lot**. Product development is not only necessary for serving larger segments of the market - it is also essential for guarding against competitors. In my experience, technical debt is the #1 contributor to (lack of) velocity of product development.

The biggest problem with technical debt is that it grows **superlinearly**. At some point you have so much of it that you stop worrying whether 10% YoY growth is enough, and you start worrying about how many years you can survive while churning 20% of your revenue each year.
...
> Re-writes are essential for success and longevity. You should be doing them more often. If you aren't doing at least **one major re-write per year** then you likely aren't iterating enough. Most re-writes fail because most developers are not experienced with them - not because they are fundamentally bad
